...
<div
  class="mdc-card mdc-layout-grid__cell--span-4-desktop mdc-layout-grid__cell--span-6-tablet mdc-layout-grid__cell--span-4-phone">
  <div class="mdc-card__primary-action battle-card">
    ...
    <div class="battle-card__content">
      <div class="mdc-layout-grid">
        <div class="mdc-layout-grid__inner">
          <div class="mdc-layout-grid__cell">
            <CorrectableInput value={battle.Statistics.Damage} label="Damage" helptext="This value does not count fire and flooding damage by default." />
          </div>
          <div class="mdc-layout-grid__cell">
            <CorrectableInput value={battle.Statistics.Kills} label="Kills" helptext="" />
          </div>
          <div class="mdc-layout-grid__cell">
            <CorrectableInput value={battle.Statistics.InDivision} label="In Division" helptext="" />
          </div>
        </div>
      </div>
    </div>
