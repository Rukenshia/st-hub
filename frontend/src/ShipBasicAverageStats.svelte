...
<div>
  <div class="mdc-text-field stat-text-field">
    ...
    <label class="absolute left-4 top-1 text-cool-gray-400 text-sm" for="{uid}averageDamage">Average Damage</label>
    <div class="mdc-line-ripple"></div>
  </div>
  <div class="mdc-text-field stat-text-field">
    <input type="text" id="{uid}averageKills" class="mdc-text-field__input" disabled value={averageKills ? averageKills : 'n/a'}>
    <label class="absolute left-4 top-1 text-cool-gray-400 text-sm" for="{uid}averageKills">Average Kills</label>
    <div class="mdc-line-ripple"></div>
  </div>
  <div class="mdc-text-field stat-text-field">
    <input type="text" id="{uid}survivalRate" class="mdc-text-field__input" disabled value={survivalRate ? (survivalRate + '%') : 'n/a'}>
    <label class="absolute left-4 top-1 text-cool-gray-400 text-sm" for="{uid}survivalRate">Survival Rate</label>
    <div class="mdc-line-ripple"></div>
  </div>
  <div class="mdc-text-field stat-text-field">
    <input type="text" id="{uid}winRate" class="mdc-text-field__input" disabled value={winRate ? (winRate + '%') : 'n/a'}>
    <label class="absolute left-4 top-1 text-cool-gray-400 text-sm" for="{uid}winRate">Win Rate</label>
    <div class="mdc-line-ripple"></div>
  </div>
</div>
